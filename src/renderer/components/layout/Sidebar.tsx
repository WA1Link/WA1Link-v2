    ...
    >
      ...
      <div className="flex items-center h-16 px-4 border-b border-gray-200">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-whatsapp-light rounded-lg flex items-center justify-center">
          ...
          {isSidebarOpen && (
            <span className="text-lg font-bold text-gray-900">WTP CRM</span>
          )}
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${
                  isActive
                    ? 'bg-whatsapp-light bg-opacity-10 text-whatsapp-dark'
