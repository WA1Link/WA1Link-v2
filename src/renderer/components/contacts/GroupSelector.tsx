  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-medium text-gray-900">WhatsApp Groups</h3>
          <p className="text-sm text-gray-500">
            {selectedIds.size} groups selected ({totalParticipants} participants)
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="text-sm">Connect your WhatsApp account and refresh</p>
        </div>
      ) : (
